...
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title bold"> Website </h1>
<!-- END PAGE TITLE-->
<!-- END PAGE HEADER-->
<div class="row">
	<div class="col-md-12">
			...
			<div class="portlet-body form">
				...
				<div class="form-body">
					<table class="table table-striped table-bordered table-hover order-column">
						...
						<tr>
							<td><a href="{{ site_url('site/edit/id/' . data_get($entity, '_id')) }}">{{ data_get($entity, '_id') }}</a></td>
							<td><a href="{{ site_url('site/edit/id/' . data_get($entity, '_id')) }}">{{ data_get($entity, 'name') }}</a></td>
							<td><a href="{{ site_url('site/edit/id/' . data_get($entity, '_id')) }}">{{ data_get($entity, 'url') }}</a></td>
							<td>
