var UINestable = function () {
	...
	return {
		init: function () {
			$("#nestable_list_1").nestable({group: 1}).on("change", t), $("#nestable_list_2").nestable({group: 1}).on("change", t), t($("#nestable_list_1").data("output", $("#nestable_list_1_output"))), t($("#nestable_list_2").data("output", $("#nestable_list_2_output"))), $("#nestable_list_menu").on("click", function (t) {
